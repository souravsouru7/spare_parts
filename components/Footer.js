      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-white/10">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">AutoParts</h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Your trusted source for high-quality automotive parts and accessories. 
              Delivering excellence in every part we offer.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3 text-gray-400">
                <svg className="w-6 h-6 text-orange-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
